...
Sample_property_dist %>% 
  ...
  leaflet(width = "70%") %>% 
    ...
    addPolygons(color = "red", weight = 50, opacity = 0.5, fillOpacity = 1, fillColor = "black")
...
bins to set up (n=4): <100, 100-125, 125-200, >200
  ...
  leaflet(width="500px",
    ...
    addPolygons(fillOpacity = 1, weight = 1, color = "grey", opacity = 1,
                ...
                labelOptions = labelOptions(noHide = T, 
                                            ...
                                            direction = "left" , 
                                            style = list("color" = "black")),
                fillColor = ~autoColour(Count_est_PV , bins = c(0,100,125,200,300))) %>% 
    addLegend( position = "bottomleft", 
               colors = c("#FFFFB2", "#FECC5C" ,"#FD8D3C", "#E31A1C"), 
               labels = c("<100","100-125","125-200" , ">200") , 
               title = "Number</br> (proportion)",
               opacity = 1) %>% 
    addScaleBar() %>% 
    mapshot(file = "./est_pv_map.png")
